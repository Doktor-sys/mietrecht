...
describe('AdvancedAlertManager with Correlation', () => {
    ...
    describe('Alert Correlation', () => {
        it('should process alerts through correlation engine', () => {
            ...
            const alert1 = alertManager.createAlert(AlertManager_1.AlertSeverity.WARNING, 'Failed Login Attempt', 'Failed login for user test', { userId: 'test', ipAddress: '192.168.1.1' });
            const alert2 = alertManager.createAlert(AlertManager_1.AlertSeverity.WARNING, 'Failed Login Attempt', 'Failed login for user test - second attempt', { userId: 'test', ipAddress: '192.168.1.1' });
