import { LegalCategory, ExtendedLegalCategory } from '../types/legal';
...
export const CATEGORY_NAMES: Record<ExtendedLegalCategory, string> = {
...
export const CATEGORY_KEYWORDS: Record<ExtendedLegalCategory, string[]> = {
...
export const MANDATORY_REFERENCES: Record<ExtendedLegalCategory, LegalReference[]> = {
    rent_reduction: [
        {
            type: 'law',
            reference: '§ 536 BGB',
...
export const TEMPLATE_MAP: Record<ExtendedLegalCategory, TemplateReference[]> = {
    rent_reduction: [
        {
...
export const ACTION_RECOMMENDATIONS_MAP: Record<ExtendedLegalCategory, ActionRecommendation[]> = {
    rent_reduction: [
        {
