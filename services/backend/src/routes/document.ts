 ...
 *         description: Nicht authentifiziert
 */
router.get('/stats', DocumentController.getStorageStats);
 ...
 *         description: Dokument nicht gefunden
 */
router.post('/:documentId/extract-text', DocumentController.extractText);
 ...
 *         description: Dokument nicht gefunden
 */
router.post('/:documentId/analyze-rental-contract', DocumentController.analyzeRentalContract);
 ...
 *         description: Dokument nicht gefunden
 */
router.post('/:documentId/analyze-utility-bill', DocumentController.analyzeUtilityBill);
 ...
 *         description: Dokument nicht gefunden
 */
router.post('/:documentId/analyze-warning-letter', DocumentController.analyzeWarningLetter);
 ...
 *         description: Dokument nicht gefunden
 */
router.post('/:documentId/annotations', DocumentController.createAnnotation);
 ...
 *         description: Dokument nicht gefunden
 */
router.get('/:documentId/annotations', DocumentController.getDocumentAnnotations);
 ...
 */
router.put('/annotations/:annotationId', DocumentController.updateAnnotation);
 ...
 *         description: Annotation nicht gefunden
 */
router.delete('/annotations/:annotationId', DocumentController.deleteAnnotation);
 ...
 *         description: Annotation nicht gefunden
 */
router.post('/annotations/:annotationId/resolve', DocumentController.resolveAnnotation);
 ...
 *         description: Document not found
 */
router.post('/:documentId/upload-version', upload.single('file'), DocumentController.uploadDocumentVersion);
 ...
 */
router.put('/shares/:shareId', DocumentController.updateShare);
 ...
 *         description: Freigabe nicht gefunden
 */
router.delete('/shares/:shareId', DocumentController.removeShare);
 ...
 *         description: Document not found
 */
router.post('/:documentId/status', DocumentController.transitionDocumentStatus);
 ...
 *         description: Document not found
 */
router.get('/:documentId/workflow-history', DocumentController.getDocumentWorkflowHistory);
 ...
 *         description: Not authenticated
 */
router.get('/workflow-rules', DocumentController.getWorkflowRules);
 ...
 *         description: Not authenticated
 */
router.post('/workflow-rules', DocumentController.createWorkflowRule);
 ...
 */
router.put('/workflow-rules/:ruleId', DocumentController.updateWorkflowRule);
 ...
 *         description: Rule not found
 */
router.delete('/workflow-rules/:ruleId', DocumentController.deleteWorkflowRule);
