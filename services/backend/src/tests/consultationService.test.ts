...
describe('ConsultationService', () => {
  ...
  beforeEach(() => {
    ...
    consultationService = new ConsultationService(prisma);
    jest.clearAllMocks();
  });
  ...
  describe('createVideoMeeting', () => {
    ...
    it('sollte Fehler werfen wenn Buchung nicht existiert', async () => {
      ...
      await expect(
        consultationService.createVideoMeeting('invalid-booking', 'jitsi')
    ...
    it('sollte Fehler werfen wenn Buchung nicht für Video konfiguriert ist', async () => {
      ...
      await expect(
        consultationService.createVideoMeeting('booking-1', 'jitsi')
  ...
  describe('startConsultation', () => {
    ...
    it('sollte Fehler werfen wenn Konsultation zu früh gestartet wird', async () => {
      ...
      await expect(
        consultationService.startConsultation('booking-1', 'user-1')
      ).rejects.toThrow(ValidationError);
    });
  });
  ...
  describe('endConsultation', () => {
    it('sollte Konsultation mit Notizen beenden', async () => {
      ...
      const updateCall = (prisma.booking.update as jest.Mock).mock.calls[0][0];
  ...
  describe('transferSecureCaseData', () => {
    ...
    it('sollte Fehler werfen wenn Fall nicht existiert', async () => {
      ...
      await expect(
        consultationService.transferSecureCaseData('booking-1', 'user-1', 'invalid-case')
      ).rejects.toThrow(NotFoundError);
    });
    ...
    it('sollte Fehler werfen wenn Nutzer nicht Besitzer des Falls ist', async () => {
      ...
      await expect(
        consultationService.transferSecureCaseData('booking-1', 'user-1', 'case-1')
      ).rejects.toThrow(ValidationError);
    });
  });
  ...
  describe('getCaseDataForLawyer', () => {
    ...
    it('sollte Fehler werfen wenn Anwalt keine Berechtigung hat', async () => {
      ...
      await expect(
        consultationService.getCaseDataForLawyer('booking-1', 'lawyer-1')
      ).rejects.toThrow(ValidationError);
    });
  });
});
