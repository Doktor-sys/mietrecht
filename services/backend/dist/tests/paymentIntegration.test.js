...
describe('Payment Integration Tests', () => {
    ...
    beforeAll(async () => {
        ...
        userId = user.id;
        authToken = (0, AuthService_1.generateToken)(user);
    ...
    describe('Partial Refund Flow', () => {
        ...
        it('sollte Teilerstattung erstellen', async () => {
            const response = await (0, supertest_1.default)(index_1.default)
                ...
                .expect(200);
            expect(response.body.success).toBe(true);
            expect(response.body.data.status).toBe(client_1.PaymentStatus.REFUNDED);
        });
    });
    ...
    describe('Error Handling', () => {
        ...
        it('sollte Fehler werfen bei Zugriff auf fremde Zahlung', async () => {
            ...
            const otherToken = (0, AuthService_1.generateToken)(otherUser);
            const response = await (0, supertest_1.default)(index_1.default)
