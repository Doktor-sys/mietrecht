...
} from '../../../scripts/ml/enhancedStrategyRecommendations';
...
describe('Enhanced Strategy Recommendations', () => {
  describe('analyzeCaseDocuments', () => {
    it('should analyze case documents correctly', () => {
      ...
      const result = analyzeCaseDocuments(documents);
    ...
    it('should handle empty documents', () => {
      const result = analyzeCaseDocuments([]);
  ...
  describe('assessCaseStrength', () => {
    it('should assess case strength correctly', () => {
      ...
      const result = assessCaseStrength(documentAnalysis, caseData);
  ...
  describe('identifyKeyIssues', () => {
    it('should identify key issues correctly', () => {
      ...
      const result = identifyKeyIssues(topics, topicModeling);
  ...
  describe('analyzeHistoricalPatterns', () => {
    it('should analyze historical patterns correctly', () => {
      ...
      const result = analyzeHistoricalPatterns(historicalData, 'mietrecht');
  ...
  describe('generateEnhancedRecommendations', () => {
    it('should generate enhanced recommendations correctly', () => {
      ...
      const result = generateEnhancedRecommendations(
        caseData,
        clientProfile,
        lawyerProfile,
        documentAnalysis,
  ...
  describe('determineEnhancedApproach', () => {
    it('should determine enhanced approach correctly', () => {
      ...
      const result = determineEnhancedApproach(caseStrength, riskTolerance, riskAssessment);
  ...
  describe('calculateEnhancedConfidence', () => {
    it('should calculate enhanced confidence correctly', () => {
      ...
      const result = calculateEnhancedConfidence(caseData, documentAnalysis, riskAssessment, historicalPatterns);
  ...
  describe('generateEnhancedStrategyRecommendations', () => {
    it('should generate enhanced strategy recommendations correctly', () => {
      ...
      const result = generateEnhancedStrategyRecommendations(
        caseData,
        clientProfile,
        lawyerProfile,
        riskAssessment,
    ...
    it('should handle missing inputs gracefully', () => {
      const result = generateEnhancedStrategyRecommendations(null, null, null, null, null);
