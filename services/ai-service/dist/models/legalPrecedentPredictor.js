...
exports.LegalPrecedentPredictor = void 0;
// Model configuration
const MODEL_CONFIG = {
    learningRate: 0.001,
    epochs: 150,
...
class LegalPrecedentPredictor {
     ...
     */
    extractDocumentFeatures(documents) {
     ...
     */
    async predict(caseData, documents) {
        if (!this.isTrained) {
     ...
     */
    identifySupportingFactors(caseData, documents, probability) {
        const factors = [];
        // High claim amount
     ...
     */
    async evaluate(testData, testDocuments) {
        if (!this.isTrained) {
            throw new Error('Model not trained yet. Please train the model first.');
        }
...
exports.LegalPrecedentPredictor = LegalPrecedentPredictor;
//# sourceMappingURL=legalPrecedentPredictor.js.map