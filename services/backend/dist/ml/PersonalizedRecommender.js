...
exports.PersonalizedRecommender = void 0;
...
class PersonalizedRecommender {
     ...
     */
    async recommendCases(lawyerId, limit = 10) {
        try {
            // Hole Anwaltsprofil
            ...
            for (const legalCase of availableCases) {
                try {
                    ...
                    logger_1.logger.error(`Error generating recommendation for case ${legalCase.id}:`, error);
                }
            }
     ...
     */
    createFeatureVector(lawyer, legalCase) {
     ...
     */
    generateReasoning(lawyer, legalCase, features) {
        const reasons = [];
        if (features[0] > 0.5) {
...
exports.PersonalizedRecommender = PersonalizedRecommender;
