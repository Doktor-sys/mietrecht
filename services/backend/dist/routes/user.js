 ...
 */
router.get('/search', (0, auth_1.authorize)(client_1.UserType.BUSINESS), userController.searchUsers);
/**
 * @swagger
 * /api/users/stats:
 *   get:
 ...
 *         description: Keine Berechtigung
 */
router.get('/stats', (0, auth_1.authorize)(client_1.UserType.BUSINESS), userController.getUserStats);
/**
 * @swagger
 * /api/users/{userId}:
 *   get:
 ...
 *         description: Benutzer nicht gefunden
 */
router.post('/:userId/reactivate', (0, auth_1.authorize)(client_1.UserType.BUSINESS), userController.reactivateUser);
