...
exports.MessagingIntegration = void 0;
...
class MessagingIntegration {
    ...
    async getMessageThreads(userId) {
        try {
            ...
            logger_1.logger.error(`Error fetching threads for user ${userId}:`, error);
    ...
    async getMessagesInThread(threadId) {
        try {
            ...
            logger_1.logger.error(`Error fetching messages in thread ${threadId}:`, error);
    ...
    async markMessageAsRead(messageId) {
        try {
            ...
            logger_1.logger.error(`Error marking message ${messageId} as read:`, error);
    ...
    async deleteMessage(messageId) {
        try {
            ...
            logger_1.logger.error(`Error deleting message ${messageId}:`, error);
    ...
    async getUserNotifications(userId) {
        try {
            ...
            logger_1.logger.error(`Error fetching notifications for user ${userId}:`, error);
    ...
    async markNotificationAsRead(notificationId) {
        try {
            ...
            logger_1.logger.error(`Error marking notification ${notificationId} as read:`, error);
    ...
    async deleteNotification(notificationId) {
        try {
            ...
            logger_1.logger.error(`Error deleting notification ${notificationId}:`, error);
...
exports.MessagingIntegration = MessagingIntegration;
