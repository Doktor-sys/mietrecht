 ...
 */
router.post('/:id/transfer-data', BookingController.transferConsultationData);
 ...
 */
router.get('/:id/case-data', BookingController.getCaseData);
 ...
 */
router.post('/:id/start-consultation', BookingController.startConsultation);
 ...
 */
router.post('/:id/end-consultation', BookingController.endConsultation);
 ...
 */
router.get('/lawyers/:lawyerId/available-slots', BookingController.getAvailableSlots);
 ...
 */
router.post('/lawyers/:lawyerId/time-slots', BookingController.createTimeSlots);
