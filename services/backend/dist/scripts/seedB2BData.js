...
exports.seedB2BData = seedB2BData;
...
async function seedB2BData() {
    ...
    try {
        ...
        for (const org of organizations) {
            ...
            const keyValue = `${keyPrefix}_${crypto_1.default.randomBytes(24).toString('hex')}`;
            let permissions;
            let rateLimit;
            let quotaLimit;
            switch (org.plan) {
            ...
            const testKeyValue = `sk_test_${crypto_1.default.randomBytes(24).toString('hex')}`;
        ...
        for (const apiKey of apiKeys) {
            ...
            for (let i = 0; i < 50; i++) {
                ...
                chatInteractions.push({
                    ...
                    sessionId: `session_${(0, uuid_1.v4)()}`,
                    query: [
        ...
        for (let i = 0; i < organizations.length; i++) {
            ...
            await prisma.webhook.create({
                data: {
                    ...
                    secret: `whsec_${crypto_1.default.randomBytes(32).toString('hex')}`,
                    isActive: true,
                },
            });
        }
