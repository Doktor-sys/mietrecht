 ...
 */
router.post('/document/:documentId', StrategyRecommendationsController.generateDocumentRecommendations);
 ...
 */
router.post('/case/:caseId', StrategyRecommendationsController.generateCaseRecommendations);
 ...
 *         description: Dokument nicht gefunden
 */
router.post('/document/:documentId/enhanced', StrategyRecommendationsController.generateEnhancedDocumentRecommendations);
 ...
 *         description: Fall nicht gefunden
 */
router.post('/case/:caseId/enhanced', StrategyRecommendationsController.generateEnhancedCaseRecommendations);
