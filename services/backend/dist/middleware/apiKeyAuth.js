...
exports.updateQuota = exports.checkQuota = exports.apiKeyRateLimit = exports.requirePermission = exports.authenticateApiKey = void 0;
...
const authenticateApiKey = async (req, res, next) => {
    try {
        ...
        if (!keyRecord) {
            logger_1.logger.warn('Invalid API key attempt', { apiKey: apiKey.substring(0, 8) + '...' });
            return res.status(401).json({
...
const checkQuota = async (req, res, next) => {
    try {
        ...
        logger_1.logger.error('Quota check error:', error);
        next();
    }
};
    ...
    res.send = function (data) {
        ...
        if (req.apiKey && res.statusCode >= 200 && res.statusCode < 300) {
            prisma.apiKey.update({
                ...
                logger_1.logger.error('Error updating quota:', error);
            });
        }
