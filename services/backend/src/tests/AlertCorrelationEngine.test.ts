import { AlertCorrelationEngine } from '../services/AlertCorrelationEngine';
import { Alert, AlertSeverity } from '../services/kms/AlertManager';
...
describe('AlertCorrelationEngine', () => {
  ...
  beforeEach(() => {
    ...
    correlationEngine = new AlertCorrelationEngine(1000); // 1 second
  });
