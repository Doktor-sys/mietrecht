...
describe('NLPService', () => {
    let nlpService;
    beforeEach(() => {
        nlpService = new NLPService_1.NLPService();
        jest.clearAllMocks();
    });
    ...
    describe('extractContext', () => {
        it('should extract context from rent reduction query', async () => {
            ...
            const result = await nlpService.extractContext('Meine Heizung ist seit 3 Wochen kaputt. Ich habe den Vermieter informiert, aber es passiert nichts.', intent);
        ...
        it('should handle high urgency cases', async () => {
            ...
            const result = await nlpService.extractContext('Ich habe eine fristlose Kündigung erhalten', intent);
