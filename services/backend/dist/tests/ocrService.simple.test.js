    ...
    describe('extractRentalContractData', () => {
      ...
      `;
        ...
        it('should extract rent with different formats', () => {
            ...
            expect(OCRService_1.default.extractRentalContractData(text1).rentAmount).toBe(1250.50);
            expect(OCRService_1.default.extractRentalContractData(text2).rentAmount).toBe(999.99);
        });
        ...
        it('should extract deposit amount', () => {
            ...
            expect(OCRService_1.default.extractRentalContractData(text1).deposit).toBe(2400.00);
            expect(OCRService_1.default.extractRentalContractData(text2).deposit).toBe(1800.50);
        });
    });
    ...
    describe('extractUtilityBillData', () => {
      ...
      `;
        ...
        it('should extract billing period with different separators', () => {
            ...
            const result1 = OCRService_1.default.extractUtilityBillData(text1);
            const result2 = OCRService_1.default.extractUtilityBillData(text2);
    ...
    describe('extractWarningLetterData', () => {
      ...
      `;
        ...
        it('should detect legal action threats', () => {
            ...
            expect(OCRService_1.default.extractWarningLetterData(text1).containsLegalThreat).toBe(true);
            expect(OCRService_1.default.extractWarningLetterData(text2).containsLegalThreat).toBe(true);
            expect(OCRService_1.default.extractWarningLetterData(text3).containsLegalThreat).toBe(true);
        });
        it('should detect termination threats', () => {
            ...
            expect(OCRService_1.default.extractWarningLetterData(text1).containsTerminationThreat).toBe(true);
            expect(OCRService_1.default.extractWarningLetterData(text2).containsTerminationThreat).toBe(true);
        });
        ...
        it('should extract deadline with different wording', () => {
            ...
            expect(OCRService_1.default.extractWarningLetterData(text1).deadline).toBe('15.04.2024');
            expect(OCRService_1.default.extractWarningLetterData(text2).deadline).toBe('20.05.2024');
        });
    });
