...
describe('AuditService', () => {
  ...
  describe('getAuditTrail', () => {
    it('sollte vollständigen Audit-Trail für Ressource abrufen', async () => {
      ...
      (prisma.auditLog.findMany as jest.Mock).mockResolvedValue(mockTrail);
  ...
  describe('generateComplianceReport', () => {
    it('sollte DSGVO-Compliance-Bericht generieren', async () => {
      ...
      (prisma.auditLog.findMany as jest.Mock).mockResolvedValue(mockGDPRLogs);
  ...
  describe('detectUnauthorizedAccess', () => {
    it('sollte unberechtigte Zugriffe erkennen', async () => {
      ...
      (prisma.auditLog.findMany as jest.Mock).mockResolvedValue(mockUnauthorizedLogs);
  ...
  describe('archiveOldLogs', () => {
    it('sollte alte Logs archivieren', async () => {
      ...
      (prisma.auditLog.updateMany as jest.Mock).mockResolvedValue({ count: 150 });
